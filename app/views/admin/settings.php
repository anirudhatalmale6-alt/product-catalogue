...
$labels = [
    ...
    'buyer_signup_mode' => ['How people get an account',
        'Vetted is the careful option: every request waits for you and you issue the login. Instant removes the wait - a visitor fills in the form, chooses their own password and is browsing seconds later. Instant never grants price access; that stays a switch you turn on per account.'],
    'buyer_gate'      => ['What signing in unlocks',
        'Start with "nothing extra" until you are sure. Prices are shown only to buyers you have individually switched on under Buyer accounts, never to everyone who happens to be signed in. Choosing the whole catalogue hides all your products from Google, so nobody new can find you through search.'],
